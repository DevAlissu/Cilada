...
const NavBarMobile = ({
  ...
  return (
    <div className="h-screen flex flex-col w-56 bg-background dark:bg-slate-900">
      {/* Logo fixa no topo */}
      <div className="h-20 bg-[#347AB6] dark:bg-blue-900 flex justify-center items-center shrink-0 border-b border-gray-300">
        <Image priority src={logo} alt="Logo" width={120} height={50} />
      </div>
