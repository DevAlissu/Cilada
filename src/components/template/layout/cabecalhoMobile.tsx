...
const LayoutPagina: React.FC<LayoutPaginaProps> = ({
  ...
  return (
    <div className="flex flex-col h-screen w-full">
      {/* Cabeçalho */}
      <div className="bg-[#347AB6] dark:bg-blue-900 text-white border-b border-gray-300 h-20 w-full flex items-center justify-between px-4 gap-4">
        <div className="mx-2">
      ...
      {/* Corpo centralizado */}
      <div className="flex-1 w-full flex justify-center items-center text-black dark:text-gray-50 border-t border-gray-300 dark:bg-black bg-white">
        {Corpo ? <Corpo /> : <div></div>}
      </div>
    </div>
  );
