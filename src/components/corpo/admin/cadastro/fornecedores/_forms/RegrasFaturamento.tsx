...
import { Fornecedor, RegraFaturamento } from '@/data/fornecedores/fornecedores';
      ...
      <div className="grid grid-cols-1 gap-4 text-gray-700">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.desc_icms_sufra',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.desc_icms_sufra === 1
              }
            ...
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.desc_icms_sufra_importado',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.desc_icms_sufra_importado === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.basereduzida_icms',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.basereduzida_icms === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.desc_icms_sufra_base',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.desc_icms_sufra_base === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.desc_icms_sufra_importado_base',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.desc_icms_sufra_importado_base ===
                  1
              }
              disabled={!disableFields.regraDiferenciada}
            />
          ...
          <div>
            ...
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.desc_icms_sufra_st',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.desc_icms_sufra_st === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.desc_piscofins_st',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.desc_piscofins_st === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.acres_piscofins_st',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.acres_piscofins_st === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
            <CheckInput
              ...
              onChange={(e) =>
                handleFornecedorChange(
                  'regra_faturamento.basereduzida_st',
                  e.target.checked ? 1 : 0,
                )
              }
              checked={
                fornecedor.regra_faturamento &&
                fornecedor.regra_faturamento?.basereduzida_st === 1
              }
              disabled={!disableFields.regraDiferenciada}
            />
          </div>
        ...
        <div>
          ...
          <CheckInput
            ...
            onChange={(e) =>
              handleFornecedorChange(
                'regra_faturamento.desc_icms_sufra_piscofins',
                e.target.checked ? 1 : 0,
              )
            }
            checked={
              fornecedor.regra_faturamento &&
              fornecedor.regra_faturamento?.desc_icms_sufra_piscofins === 1
            }
            disabled={!disableFields.regraDiferenciada}
          />
          <div className="grid grid-cols-2 gap-4">
            <SelectInput
              ...
              defaultValue={
                String(fornecedor.regra_faturamento?.piscofins_365) || ''
              }
              onValueChange={(value) =>
                handleFornecedorChange(
                  'regra_faturamento.piscofins_365',
                  Number(value),
                )
              }
              error={error?.piscofins_365}
              disabled={!disableFields.regraDiferenciada}
            />
            <SelectInput
              name="piscofins_925"
              ...
              options={pisCofinsOptions}
              defaultValue={
                String(fornecedor.regra_faturamento?.piscofins_925) || ''
              }
              onValueChange={(value) =>
                handleFornecedorChange(
                  'regra_faturamento.piscofins_925',
                  Number(value),
                )
              }
              error={error?.piscofins_925}
              disabled={!disableFields.regraDiferenciada}
            />
            <SelectInput
              name="piscofins_1150"
              ...
              defaultValue={
                String(fornecedor.regra_faturamento?.piscofins_1150) || ''
              }
              onValueChange={(value) =>
                handleFornecedorChange(
                  'regra_faturamento.piscofins_1150',
                  Number(value),
                )
              }
              error={error?.piscofins_1150}
              disabled={!disableFields.regraDiferenciada}
            />
            <SelectInput
              name="piscofins_1310"
              ...
              defaultValue={
                String(fornecedor.regra_faturamento?.piscofins_1310) || ''
              }
              onValueChange={(value) =>
                handleFornecedorChange(
                  'regra_faturamento.piscofins_1310',
                  Number(value),
                )
              }
              error={error?.piscofins_1310}
              disabled={!disableFields.regraDiferenciada}
            />
          </div>
        </div>
        <div>
          ...
          <CheckInput
            ...
            onChange={(e) =>
              handleFornecedorChange(
                'regra_faturamento.cobrar_ipi_importado',
                e.target.checked ? 1 : 0,
              )
            }
            checked={
              fornecedor.regra_faturamento &&
              fornecedor.regra_faturamento?.cobrar_ipi_importado === 1
            }
            disabled={!disableFields.regraDiferenciada}
          />
        </div>
        <SelectInput
          ...
          defaultValue={String(fornecedor.regra_faturamento?.frete) || ''}
          onValueChange={(value) =>
            handleFornecedorChange('regra_faturamento.frete', value)
          }
          error={error?.frete}
          disabled={!disableFields.regraDiferenciada}
        />
