...
import {
  ClassesVendedor,
  DetalhadoVendedor,
  getClassesVendedor, getVendedor,
  updateVendedor,
  Vendedor,
  VendedorPst,
...
export default function CustomModal({
  ...
  }, [vendedorId, searchOptions.classeVendedor, searchOptions.bairro, searchOptions.grupoProduto]);
  ...
  const handleSubmit = () => {
    try {
      ...
      setErrors({});
      setMensagemInfo('Vendedor atualizado com sucesso!');
      setOpenInfo(true);
    } catch (error) {
