...
const ComprasTabs: React.FC<ComprasTabsProps> = ({
  activeComprasTab,
  setActiveComprasTab,
}) => {
      ...
      case 'titulosVencer':
        return (
          <table className="min-w-full divide-y divide-gray-200 border border-gray-300">
            ...
            <tbody className=" dark:text-gray-200 divide-y divide-gray-200 text-gray-700">
              <tr>
    ...
    <div>
      <nav className="flex space-x-4 border-b-2 mt-4 mb-4 text-[#347AB6]">
        <button
          ...
          className={`px-4 py-2 ${
            activeComprasTab === 'ultimosMeses'
              ? 'border-b-4 border-[#347AB6] dark:border-blue-900 font-bold'
              : ''
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 ${
            activeComprasTab === 'titulosVencer'
              ? 'border-b-4 border-[#347AB6] dark:border-blue-900 font-bold'
              : ''
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 ${
            activeComprasTab === 'titulosVencidos'
              ? 'border-b-4 border-[#347AB6] dark:border-blue-900 font-bold'
              : ''
          }`}
        >
