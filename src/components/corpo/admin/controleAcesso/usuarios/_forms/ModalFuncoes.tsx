  ...
  return (
    ...
    >
      <div className="bg-white  dark:bg-zinc-900 rounded-lg shadow-lg w-[100%] h-[90%] flex flex-col overflow-hidden">
        ...
        <div className="sticky top-0 z-10 bg-white dark:bg-zinc-900 px-4 py-2 border-b border-zinc-200 dark:border-zinc-700 flex gap-2">
          <Select
            value={filtroUsadoEm}
            onValueChange={(value) => setFiltroUsadoEm(value)}
          >
            <SelectTrigger className="w-full">{filtroUsadoEm}</SelectTrigger>
            <SelectContent>
              ...
              {funcoesFiltradas.map((funcao) => {
                ...
                return (
                  <tr
                    ...
                    onClick={() => toggleFuncao(funcao)} // Ação ao clicar na linha
                  >
                    <td className="px-4 py-2">
                      <div className="flex items-center">
                        <Checkbox
                          ...
                          onClick={(e) => e.stopPropagation()} // Evita disparar o evento da linha
                        />
